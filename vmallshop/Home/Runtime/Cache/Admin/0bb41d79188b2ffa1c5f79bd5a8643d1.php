...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					<b>搜索</b> &nbsp; 关键字：<input type="text" name="keyword" value="<?php echo ($_POST['keyword']); ?>" /> 						&nbsp;&nbsp;<input size="10" type="text" name="classid" value="<?php echo ($_POST['classid']); ?>"/>
				</td>
				<td>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/vmallshop/index.php/Admin/OrderDesc/add" target="dialog" width="550" height="380" rel="user_msg" title="添加链接信息"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="112">
		<thead>
			<tr>
				...
				<th width="40" orderField="goods_no" <?php if($_REQUEST['_order']== 'goods_no'): ?>class="<?php echo ($_REQUEST['_sort']); ?>"<?php endif; ?>>商品编号</th>
