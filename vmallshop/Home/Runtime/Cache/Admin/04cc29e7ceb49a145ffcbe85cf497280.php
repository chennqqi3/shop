...
<div class="pageContent">
	<form method="post" action="/vmallshop/index.php/Admin/IndexSale/insert/navTabId/listadd/callbackType/closeCurrent"  class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);" enctype="multipart/form-data"><?php  ?>
