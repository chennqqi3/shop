				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							...
							<li><a href="/vmallshop/index.php/Admin/Ad/add" target="dialog" width="550" height="300">添加广告信息</a></li>
						</ul>
					</div>
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							...
							<li><a href="/vmallshop/index.php/Admin/IndexSale/add" target="dialog" width="550" height="300">添加首页信息</a></li>
						</ul>
					</div>
							...
							<table border="1" cellspacing='0'  style="width:60%;height:auto;border-collapse:collapse;height:60%;color:#183152;margin-left:200px;border-color:#EBF1F3;">
                             ...
                             <caption><h3>欢迎管理员,以下是个人信息:</h3></caption>
								...
								<tr>
								 ...
								 <td style="border-color:#EBF1F3;"><?php echo ($actions); ?></td>
								</tr>
                             </table>							
						</div>
						<!--
