<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/vmallshop/index.php/Admin/IndexSale/index" method="post">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="delete" href="/vmallshop/index.php/Admin/IndexSale/del/index_sale_id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>/navTabId/listsale" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
