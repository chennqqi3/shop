...
<script src="/vmallshop/Public/Js/jquery-1.js"></script>
<script src="/vmallshop/Public/Js/ec_002.js"></script> 
<script src="/vmallshop/Public/Js/ec.js"></script> 
<!--[if lt IE 9]><script src="/vmallshop/Public/Js/html5shiv.js"></script> <![endif]-->
        ...
        <div id="ct-list" class="g-l-none search-area">
            <div class="h">
                ...
                <div class="sort-area clearfix">
                    <ul>
                    	<li><b>商品排序：</b></li>
                        <li id="sort-price"><a href="<?php echo U('Search/index',array('keywords'=>$keywords,'order'=>'price'));?>" class="sort-price">价格<s></s></a></li>
                        <li id="sort-register_date"><a href="<?php echo U('Search/index',array('keywords'=>$keywords,'order'=>'time'));?>" class="sort-added" >上架时间<s></s></a></li>
                    </ul>
                </div>
            </div>
            <div class="b">
				...
				<?php if(is_array($list_goods)): $i = 0; $__LIST__ = $list_goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						<div>
						<p class="p-img"><a href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" title="<?php echo ($vo["goods_keywords"]); ?>" target="_blank"><img src="/vmallshop/Upload<?php echo ($vo["goods_tiny_pic"]); ?>" alt="<?php echo ($vo["goods_name"]); ?>"></a></p>
						...
						<p class="p-name"><a href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" title="<?php echo ($vo["goods_name"]); ?>" target="_blank"><span class="red"><?php echo ($vo["goods_name"]); ?></span></a></p>
						  ...
						  <?php if($vo['goods_state'] == '热卖'): ?><i><img  src="/vmallshop/Public/Images/1382542488099.png"  style=""></i>
				          <?php elseif($vo['goods_state'] == '新品'): ?>
					              <i><img  src="/vmallshop/Public/Images/1382542518162.png"  style=""></i>
				           <?php elseif($vo['goods_state'] == '人气'): ?>
				                  <i><img  src="/vmallshop/Public/Images/1382542555129.png"  style=""></i>
				          <?php elseif($vo['goods_state'] == '首发'): ?>
				                  <i><img  src="/vmallshop/Public/Images/1382593860805.png"  style=""></i>  
			              <?php else: ?>
					             <i></i><?php endif; ?>
						</div>
