...
<div class="g">
	<!--面包屑 -->
	<div class="breadcrumb-area icon-breadcrumb fcn">您最近的位置：<a href="#" title="首页">首页</a>&nbsp;>&nbsp;<a href="#" title="帮助中心">帮助中心</a>&nbsp;>&nbsp;<b>查询订单</b></div>
</div>
<div class="hr-15"></div>
<div class="g">
    <div class="fr u-4-5">
        ...
        <div class="help-detail-area">
        	...
        	<div class="b"><p>1.打开华为商城网站（<a href="javascript:if(confirm('http://www.vmall.com/  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ �������·��������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://www.vmall.com/'" tppabs="http://www.vmall.com/" target="_blank" title="华为商城">www.vmall.com</a>），点击网页顶部“我的订单”（如下图红框部分所示），商城网页会自动进入“我的订单”页面；如果您没有登录，商城网页会先进入登录页面，您登陆后，商城网页会自动进入“我的订单”页面；</p>
...
<p>3. 在“订单详情”页面，您可以查看订单所处的状态；华为商城的一个新订单从下单到订单完成，会经历“提交订单”、“付款成功”、“商品出库”、“等待收货”与“收货并确认”这几种状态；</p>
<p style="text-align:center;"><img src=" ../../res.vmall.com/20140801/images/help/M1.5/image003.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.5/image003.jpg" alt="" /></p>
 
<p>流程图表示您订单目前所处的状态，上图中的订单处于“提交订单”成功状态；</p>
<p>表格详细展现您订单所处的状态，上图中的订单“已经通过系统自动审核”。</p>

<p>订单状态说明：</p>
<p style="text-align:center;"><img src=" ../../res.vmall.com/20140801/images/help/M1.5/image004.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.5/image004.jpg" alt="" /></p>
