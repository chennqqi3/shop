...
<div class="g">
	<!--面包屑 -->
	<div class="breadcrumb-area icon-breadcrumb fcn">您最近的位置：<a href="#" title="首页">首页</a>&nbsp;>&nbsp;<a href="#" tppabs="#" title="帮助中心">帮助中心</a>&nbsp;>&nbsp;<b>找回密码</b></div>
</div>
<div class="hr-15"></div>
...
<div class="g">
    <div class="fr u-4-5">
        ...
        <div class="help-detail-area">
        	...
        	<div class="b"><p>如果您忘记了密码，华为商城为您提供了找回密码的服务。请在忘记密码的页面中输入您的华为商城账号，并按照网页提示进行操作，便可找回您的密码，具体操作方式如下所示。</p>

<p><b>一、邮箱账号密码找回操作步骤</b>
&nbsp;&nbsp;<a class="#" title="#"><span>找回密码</span></a></p>

<p>1.&nbsp;在商城会员登陆页面点击“忘记密码”（如下图红框部分所示），商城网页会自动进入“找回密码”页面；</p>
 <p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image001.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image001.jpg" alt="" /></p>
 
<p>2.&nbsp;在“找回密码”页面，输入您的华为商城账号（电子邮箱账号），如下图所示，然后点击“下一步”按钮；
</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image002.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image002.jpg" alt="" /></p>



<p>3.&nbsp;按照网页提示输入验证码，然后点击“找回密码”按钮，如下图所示；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image003.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image003.jpg" alt="" /></p>

<p>4.&nbsp;商城会自动给您的邮箱发一封密码修改的邮件，并出现下图的提示；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image004.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image004.jpg" alt="" /></p>
 
<p>5.&nbsp;请登录邮箱查看邮件，并通过邮件提供的网址及时重新设置自己的账户密码；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image005.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image005.jpg" alt="" /></p>
 
<p>6.&nbsp;通过邮件提供的网址进入密码重置页面，请输入您的新密码，然后点击“提交”按钮；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image006.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image006.jpg" alt="" /></p>
 
<p>7.&nbsp;提交新密码后，系统会提示您找回密码成功，如下图所示；之后登录商城请使用新密码进行登录。</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image007.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image007.jpg" alt="" /></p>
 

<p><b>二、手机账号密码找回操作步骤</b>
&nbsp;&nbsp;<a class="button-style-5" target="_blank" href="javascript:if(confirm('http://hwid1.vmall.com:8080/oauth2/portal/login.jsp?validated=true&service=http%3A%2F%2Fwww.vmall.com%2Faccount%2Fcaslogin%3Furl%3D%252F  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ �������·��������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://hwid1.vmall.com:8080/oauth2/portal/login.jsp?validated=true&service=http%3A%2F%2Fwww.vmall.com%2Faccount%2Fcaslogin%3Furl%3D%252F'" tppabs="http://hwid1.vmall.com:8080/oauth2/portal/login.jsp?validated=true&service=http%3A%2F%2Fwww.vmall.com%2Faccount%2Fcaslogin%3Furl%3D%252F"title=""><span>找回密码</span></a></p>

<p>1.&nbsp;在商城会员登陆页面点击“忘记密码”（如下图红框部分所示），商城网页会自动进入“找回密码”页面；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image001.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image001.jpg" alt="" /></p>
 
<p>2.&nbsp;在“找回密码”页面，输入您的华为商城账号（手机号码），如下图所示，然后点击“下一步”按钮；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image008.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image008.jpg" alt="" /></p>
 
<p>3.&nbsp;点击“获取验证码”按钮，您注册的手机便会收到华为商城发送的验证码，请将收到的验证码填写在“手机验证码”旁边的方框中（如下图所示）；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image009.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image009.jpg" alt="" /></p>
 
<p>4.&nbsp;输入账号新密码，输入验证码；然后点击“找回密码”按钮；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image010.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image010.jpg" alt="" /></p>
 
<p>5.&nbsp;提交新密码后，系统会提示您手机重置密码成功，如下图所示；之后登录商城请使用新密码进行登录。</p>
 <p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.2/image011.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.2/image011.jpg" alt="" /></p>
