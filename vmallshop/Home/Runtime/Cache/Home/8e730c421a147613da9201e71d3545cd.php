...
<div class="g">
	<!--面包屑 -->
	<div class="breadcrumb-area icon-breadcrumb fcn">您最近的位置：<a href="#" title="首页">首页</a>&nbsp;>&nbsp;<a href="#" title="帮助中心">帮助中心</a>&nbsp;>&nbsp;<b>查询物流</b></div>
</div>
<div class="hr-15"></div>
<div class="g">
    <div class="fr u-4-5">
        ...
        <div class="help-detail-area">
        	...
        	<div class="b"><p>1.打开华为商城网站（<a href="javascript:if(confirm('http://www.vmall.com/  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ �������·��������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://www.vmall.com/'" tppabs="http://www.vmall.com/" target="_blank" title="华为商城">www.vmall.com</a>），点击网页顶部“我的订单”（如下图红框部分所示），商城网页会自动进入“我的订单”页面；如果您没有登录，商城网页会自动进入登录页面，您登陆后，商城网页会自动进入“我的订单”页面；</p>
...
<p>2.在“我的订单”页面，选择您要查看的订单，点击该订单的订单编号，商城网页会自动进入“订单详情”页面；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.5/image002.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.5/image002.jpg" alt="" /></p>
 
<p>3. 在“订单详情”页面，您可以查看商品所处的状态；华为商城的一个新订单从下单到订单完成，会经历“提交订单”、“付款成功”、“商品出库”、“等待收货”与“收货并确认”这几种状态；</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.9/image003.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.9/image003.jpg" alt="" /></p>
 
<p>流程图表示您订单目前所处的状态，上图中的订单处于“提交订单”成功状态；</p>
<p>表格详细说明了您订单所处的状态，上图中的订单“已经通过系统自动审核”。</p>

<p>4. 当商品所处状态为“等待收货”时，商城系统会自动显示您的货运单号；您可以根据相应的货运单号，去<a href="javascript:if(confirm('http://www.sf-express.com/cn/sc/  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ �������·��������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://www.sf-express.com/cn/sc/'" tppabs="http://www.sf-express.com/cn/sc/" target="_blank" title="顺丰官网">顺丰官网</a>或邮政快递<a href="javascript:if(confirm('http://www.ems.com.cn/  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ �������·��������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://www.ems.com.cn/'" tppabs="http://www.ems.com.cn/" target="_blank" title="EMS官网">EMS官网</a>查询商品的配送情况。</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.9/image004.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.9/image004.jpg" alt="" /></p>

 <p><b>顺丰官网商品配送情况查询</b></p>
<p>查询前请核对您手中的快递单号是否为顺丰快递单号：顺丰快递单号由12位数字组成，常以当地电话区号后3位开头。</p>
<p>打开<a href="javascript:if(confirm('http://www.sf-express.com/cn/sc/  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ �������·��������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://www.sf-express.com/cn/sc/'" tppabs="http://www.sf-express.com/cn/sc/" target="_blank" title="顺丰官网">顺丰官网</a>，在网页左上角的“快件追踪”输入框中输入您的快递单号，然后输入验证码，点击“查询”按钮，便可查询到您所购商品的配送情况。</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.8/image002.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.8/image002.jpg" alt="" /></p>
 

<p><b>邮政快递EMS官网商品配送情况查询</b></p>
<p>查询前请核对您手中的快递单号是否为EMS快递单号：EMS快递单号开头和结尾2位均是字母，中间是9位数字。</p>
<p>打开邮政快递<a href="javascript:if(confirm('http://www.ems.com.cn/  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ �������·��������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://www.ems.com.cn/'" tppabs="http://www.ems.com.cn/" target="_blank" title="EMS官网">EMS官网</a>，在网页左上角的输入框中输入您的快递单号与验证码，点击“查询”按钮，便可查询到您所购商品的配送情况。</p>
<p style="text-align:center;"><img src="../../res.vmall.com/20140801/images/help/M1.8/image003.jpg" tppabs="http://res.vmall.com/20140801/images/help/M1.8/image003.jpg" alt="" /></p>
