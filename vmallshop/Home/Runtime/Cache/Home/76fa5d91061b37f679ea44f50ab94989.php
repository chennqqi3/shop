...
<link href="/vmallshop/Public/Css/index.css" rel="stylesheet" type="text/css">
<link href="/vmallshop/Public/Css/ad.css" rel="stylesheet" type="text/css">
<link href="/vmallshop/Public/Css/aad.css" rel="stylesheet" type="text/css">
<script src="/vmallshop/Public/Js/jsapi.js" namespace="ec"></script>
<script src="/vmallshop/Public/Js/jquery-1.4.4.min.js"></script>
<script src="/vmallshop/Public/Js/ec.core.js"></script>
<script src="/vmallshop/Public/Js/ec.business.js"></script> 
<script src="/vmallshop/Public/Js/html5shiv.js"></script>
<script type="text/javascript" src="/vmallshop/Public/Js/jquery.min.js"></script>
<style type="text/css">
		...
		<nav class="naver">
			<ul id="naver-list">
				...
				<li id="nav-sale">
					...
					<span>荣耀6<s><img src="/vmallshop/Public/Images/new.png" alt="new"></s></span></a>
				</li>
...
$(function() {
	...
	<div class="wrapper" style="height:350px">
		<div id="focus">
			<ul>
				<li><a href="#"><img src="/vmallshop/Public/Images/20140902173833602.jpg" alt="HW商城" /></a></li>
				<li><a href="#"><img src="/vmallshop/Public/Images/20140903183551979.jpg" alt="HW商城" /></a></li>
				<li><a href="#"><img src="/vmallshop/Public/Images/20140902135825589.jpg" alt="HW商城" /></a></li>
				<li><a href="#"><img src="/vmallshop/Public/Images/20140715104638522.jpg" alt="HW商城" /></a></li>
				<li><a href="#"><img src="/vmallshop/Public/Images/20140702124823618.jpg" alt="HW商城" /></a></li>
			</ul>
		</div>
	</div><!-- wrapper end -->
</div>
	...
	<ul class="channel-pro-list" id="main-sale-list">
		<?php if(is_array($hot)): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li id="1" class="channel-pro-item channel-pro-favorable-item-1">
				<div class="channel-pro-panels">
					<div class="pro-info">
						<div class="p-img">
							<a href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" title="<?php echo ($vo["index_sale_title"]); ?>" target="_blank"><img src="/vmallshop/Upload<?php echo ($vo["index_sale_img"]); ?>" alt="#"></a>
						</div>
						...
						<div class="p-countdown hide">
						 ...
						 <?php if($vo['goods_state'] == '热卖'): ?><i  class="p-tag"><img  src="/vmallshop/Public/Images/1382542488099.png"  style=""></i>
				         <?php elseif($vo['goods_state'] == '新品'): ?>
					         <i class="p-tag"><img  src="/vmallshop/Public/Images/1382542518162.png"  style=""></i>
				        <?php elseif($vo['goods_state'] == '人气'): ?>
				           <i class="p-tag"><img  src="/vmallshop/Public/Images/1382542555129.png"  style=""></i>
				        <?php elseif($vo['goods_state'] == '首发'): ?>
				             <i class="p-tag"><img  src="/vmallshop/Public/Images/1382593860805.png"  style=""></i>  
	...
	<div class="ec-slider" id="group-slider" style="width: 276px; height: 310px;">
		<ul class="channel-pro-list ec-slider-list" id="slider-sale-list" style="width: 1656px; height: 310px;">
			<li class="channel-pro-item ec-slider-item" data-block="slider" style="width: 276px; height: 310px;">
				<p><a target="_blank" href="#"><img src="/vmallshop/Public/Images/20140830182737537.jpg" title="荣耀6_联通购机送费.jpg"></a><br></p>
			</li>
		</ul>
	</div>
</div>
...
<!-- 20130904-频道-促销-end -->
		...
		<div class="banner">
			<p><a target="_blank" href="#"><img src="/vmallshop/Public/Images/20140509105527587.jpg"></a></p>
	...
	<div class="banner">
		...
		<div class="wrapper" style="height:160px">
			<div id="focuss" style="height:160px">
				<ul>
					<li><a href="#"><img src="/vmallshop/Public/Images/2014082514223543.jpg" alt="HW商城" /></a></li>
					<li><a href="#"><img src="/vmallshop/Public/Images/20140701150453324.jpg" alt="HW商城" /></a></li>
					<li><a href="#"><img src="/vmallshop/Public/Images/20140825143256198.jpg" alt="HW商城" /></a></li>
					<li><a href="#"><img src="/vmallshop/Public/Images/20140830171414397.jpg" alt="HW商城" /></a></li>
					<li><a href="#"><img src="/vmallshop/Public/Images/20140904180339478.jpg" alt="HW商城" /></a></li>
				</ul>
			</div>
		</div><!-- wrapper end -->
	...
	<div class="channel-floor">
		...
		<div class="b">
			<ul class="channel-pro-list">
				<?php if(is_array($phone)): $k = 0; $__LIST__ = $phone;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if(($vo['index_sale_id']) == "9"): ?><li id="<?php echo ($vo["index_sale_id"]); ?>" class="channel-pro-item channel-pro-rec-item">
							<div class="channel-pro-panels">
								<div class="pro-info">
									<div class="p-img">
										<a href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" title="<?php echo ($vo["index_sale_title"]); ?>" target="_blank" rel="nofollow">
											<img src="/vmallshop/Upload<?php echo ($vo["index_sale_img"]); ?>">
										</a>
									</div>
									<div class="p-name">
								...
								<div class="pro-info">
									<div class="p-img">
										<a href="#" title="<?php echo ($vo["index_sale_title"]); ?>" target="_blank" rel="nofollow">
											<img alt="" src="/vmallshop/Upload<?php echo ($vo["index_sale_img"]); ?>">
										</a>
									</div>
									<div class="p-name">
...
<div class="layout">
	...
	<div class="channel-floor">
		...
		<div class="b">
			<ul class="channel-pro-list">
			  <?php if(is_array($compt)): $k = 0; $__LIST__ = $compt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if(($vo['index_sale_id']) == "16"): ?><li id="<?php echo ($vo["index_sale_id"]); ?>" class="channel-pro-item channel-pro-rec-item">
							<div class="channel-pro-panels">
								<div class="pro-info">
									<div class="p-img">
										<a href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" title="<?php echo ($vo["index_sale_title"]); ?>" target="_blank" rel="nofollow">
...
<div class="layout">
	...
	<div class="ad fl"><a target="_blank" href="#"><img src="/vmallshop/Public/Images/20140825101353417.jpg" title="M1" style="float:none;"></a></div>
...
<div class="follow">
	<div class="layout">
		<ul>
			<li><a href="#" class="follow-sina"><img alt="关注新浪微博" src="/vmallshop/Public/Images/follow_sina.png"></a></li>
			<li><a href="#" class="follow-weibo"><img alt="关注腾讯微博" src="/vmallshop/Public/Images/follow_weibo.png"></a></li>
			<li onmouseout="this.className=''" onmouseover="this.className='hover'" class=""><a href="javascript:;" class="follow-android"><img alt="下载手机客户端" src="/vmallshop/Public/Images/follow_android.png"></a><div class="follow-panel follow-panel-qrcode"><img src="/vmallshop/Public/Images/img67.png"><p><b>扫描二维码下载</b></p><s></s></div></li>
		</ul>
	</div>
</div>
<!-- 20130902-关注-end -->
...
<div id="globleParameter" class="hide" context="" stylepath="/vmallshop/Public/Css" scriptpath="/vmallshop/Public/Js" imagepath="/vmallshop/Public/Images" mediapath="/vmallshop/Public/Images/"></div>
<!--底部 -->
<footer class="footer">
	...
	<div class="footer-warrant-area"><p>Copyright © 2011-2013  华为软件技术有限公司  版权所有  保留一切权利  苏B2-20130048号 | 苏ICP备09062682号-9            </p><p><a target="_blank" href="/vmallshop/Public/Images/wwwz.jpg">网络文化经营许可证苏网文[2012]0401-019号</a></p><p class="footer-warrant-img">   <a href="#" target="_blank"><img title="经营性网站" alt="经营性网站" src="/vmallshop/Public/Images/certificate_01_112_40.png"></a> <a title="诚信网站" href="#" rel="nofollow" target="_blank"><img alt="诚信网站" src="/vmallshop/Public/Images/certificate_02_112_40.png"></a> <a title="诚信网站" href="#" rel="nofollow" target="_blank"><img alt="诚信网站" src="/vmallshop/Public/Images/certificate_03_112_40.png"></a></p></div><!--授权结束 -->
</footer>
