...
<link href="/vmallshop/Public/Css/person/ec.core.css" rel="stylesheet" type="text/css">
                        ...
                        <tr>
                            <td class="tal">
                                <div class="pro-area clearfix">
                                    <p class="p-img">
                                    	<a title="<?php echo ($vo["goods_name"]); ?>" href="<?php echo U('Product/index',array('g'=>$vo['goods_id']));?>" target="_blank">
                                    	<img alt="<?php echo ($vo["goods_name"]); ?>" src="/vmallshop/Upload<?php echo ($vo["goods_tiny_pic"]); ?>">
